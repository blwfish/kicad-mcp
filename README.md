...
The server provides <!-- tool-count -->18<!-- /tool-count --> tools — 12 domain routers and 6 standalones:
...
- **`get_usage_guidance`** *(standalone)* — known issues and best practices; call once at the start of a session
