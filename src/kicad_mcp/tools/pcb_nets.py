...
"""
    ...
    def update_pcb_from_schematic(
        ...
        pad_assignments = []  # List of {"reference", "pad", "net", "pinfunction"}
        ...
        for net_elem in nets_element.findall("net"):
            ...
            # Skip unconnected-* nets — they are auto-generated by KiCad
            # for pins that have no intentional connection and just add
            # noise to the PCB net list.
